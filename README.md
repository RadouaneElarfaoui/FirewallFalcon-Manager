...
For step-by-step instructions on opening ports in the Oracle Cloud Console and managing your VPS configuration, please refer to our dedicated guide:

👉 **[ORACLE_CLOUD.md](ORACLE_CLOUD.md)**
